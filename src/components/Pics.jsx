...
const Pics = () => {
  ...
  <p className='text-white md:w-1/ mx-auto px-4 md:text-2xl '>A simple paragraph is comprised of three major components. The which is often a declarative sentence</p>
    <div className="flex [&:hover>div]:w-16 [&>div:hover]:w-[30rem] p-6">
      ...
      <div className="group relative h-96 w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-200">
        ...
        <div className="invisible absolute inset-0 bg-gradient-to-b from-green-500/20 to-black group-hover:visible">
          <div className="absolute inset-x-5 bottom-6">
            <div className="flex gap-3 text-white">
              <svg width="48" height="48" viewBox="0 0 24 24"><path fill="currentColor"
    ...
    <button className='px-4 py-2 gBg text-white rounded-md -ml-2
          cursor-pointer hover:bg-white hover:text-blue hover:border duration-15 transition-all'>Start a free enterprice trial ></button>
  </div>
</div>
  )
}
